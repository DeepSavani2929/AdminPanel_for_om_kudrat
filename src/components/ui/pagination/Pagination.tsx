...
//           className="border border-gray-300 rounded-md px-2 py-1 ms-1 me-1 text-sm bg-white dark:bg-gray-800 dark:text-gray-300 focus:outline-none"
//         >
...
//             </option>
//           ))}
//         </select> <span className="pe-1">of</span>
